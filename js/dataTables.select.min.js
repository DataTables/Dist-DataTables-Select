/*!
 Select for DataTables 1.1.0-dev
...
1,f.length):(c>b&&(r=b,b=c,c=r),f.splice(b+1,f.length),f.splice(0,c)),a[d](h,{selected:!0}).any())?(f.splice(e.inArray(h,f),1),a[d+"s"](f).deselect()):a[d+"s"](f).select():(c=a[d+"s"]({selected:!0}),f&&1===c.flatten().length?a[d](h).deselect():(c.deselect(),a[d](h).select())):a[d](h).select(!f)}function o(c,a){return function(b){return b.i18n("buttons."+c,a)}}var g=e.fn.dataTable;g.select={};g.select.version="1.1.0-dev";e.each([{type:"row",prop:"aoData"},{type:"column",prop:"aoColumns"}],function(c,
a){g.ext.selector[a.type].push(function(b,d,c){var d=d.selected,e,f=[];if(d===j)return c;for(var g=0,i=c.length;g<i;g++)e=b[a.prop][c[g]],(!0===d&&!0===e._select_selected||!1===d&&!e._select_selected)&&f.push(c[g]);return f})});g.ext.selector.cell.push(function(c,a,b){var a=a.selected,d,h=[];if(a===j)return b;for(var e=0,f=b.length;e<f;e++)d=c.aoData[b[e].row],(!0===a&&d._selected_cells&&!0===d._selected_cells[b[e].column]||!1===a&&(!d._selected_cells||!d._selected_cells[b[e].column]))&&h.push(b[e]);
return h});var i=g.Api.register,m=g.Api.registerPlural;i("select()",function(){});i("select.blurable()",function(c){return c===j?this.context[0]._select.blurable:this.iterator("table",function(a){a._select.blurable=c})});i("select.info()",function(c){return u===j?this.context[0]._select.info:this.iterator("table",function(a){a._select.info=c})});i("select.items()",function(c){return c===j?this.context[0]._select.items:this.iterator("table",function(a){a._select.items=c;k(new g.Api(a),"selectItems",
[c])})});i("select.style()",function(c){return c===j?this.context[0]._select.style:this.iterator("table",function(a){a._select.style=c;if(!a._select_init){var b=new g.Api(a);a.aoRowCreatedCallback.push({fn:function(b,d,c){d=a.aoData[c];d._select_selected&&e(b).addClass(a._select.className);b=0;for(c=a.aoColumns.length;b<c;b++)(a.aoColumns[b]._select_selected||d._selected_cells&&d._selected_cells[b])&&e(d.anCells[b]).addClass(a._select.className)},sName:"select-deferRender"});b.on("preXhr.dt.dtSelect",
function(){var a=b.rows({selected:!0}).ids(!0).filter(function(b){return b!==j}),d=b.cells({selected:!0}).eq(0).map(function(a){var d=b.row(a.row).id(!0);return d?{row:d,column:a.column}:j}).filter(function(b){return b!==j});b.one("draw.dt.dtSelect",function(){b.rows(a).select();d.any()&&d.each(function(a){b.cells(a.row,a.column).select()})})});b.on("draw.dtSelect.dt select.dtSelect.dt deselect.dtSelect.dt",function(){u(b)});b.on("destroy.dtSelect",function(){q(b);b.off(".dtSelect")})}var d=new g.Api(a);
q(d);"api"!==c&&t(d);k(new g.Api(a),"selectStyle",[c])})});i("select.selector()",function(c){return c===j?this.context[0]._select.selector:this.iterator("table",function(a){q(new g.Api(a));a._select.selector=c;"api"!==a._select.style&&t(new g.Api(a))})});m("rows().select()","row().select()",function(c){var a=this;if(!1===c)return this.deselect();this.iterator("row",function(b,a){n(b);b.aoData[a]._select_selected=!0;e(b.aoData[a].nTr).addClass(b._select.className)});this.iterator("table",function(b,
d){k(a,"select",["row",a[d]],!0)});return this});m("columns().select()","column().select()",function(c){var a=this;if(!1===c)return this.deselect();this.iterator("column",function(b,a){n(b);b.aoColumns[a]._select_selected=!0;var c=(new g.Api(b)).column(a);e(c.header()).addClass(b._select.className);e(c.footer()).addClass(b._select.className);c.nodes().to$().addClass(b._select.className)});this.iterator("table",function(b,d){k(a,"select",["column",a[d]],!0)});return this});m("cells().select()","cell().select()",
function(c){var a=this;if(!1===c)return this.deselect();this.iterator("cell",function(a,d,c){n(a);d=a.aoData[d];d._selected_cells===j&&(d._selected_cells=[]);d._selected_cells[c]=!0;d.anCells&&e(d.anCells[c]).addClass(a._select.className)});this.iterator("table",function(b,d){k(a,"select",["cell",a[d]],!0)});return this});m("rows().deselect()","row().deselect()",function(){var c=this;this.iterator("row",function(a,b){a.aoData[b]._select_selected=!1;e(a.aoData[b].nTr).removeClass(a._select.className)});
this.iterator("table",function(a,b){k(c,"deselect",["row",c[b]],!0)});return this});m("columns().deselect()","column().deselect()",function(){var c=this;this.iterator("column",function(a,b){a.aoColumns[b]._select_selected=!1;var d=new g.Api(a),c=d.column(b);e(c.header()).removeClass(a._select.className);e(c.footer()).removeClass(a._select.className);d.cells(null,b).indexes().each(function(b){var c=a.aoData[b.row],d=c._selected_cells;c.anCells&&(!d||!d[b.column])&&e(c.anCells[b.column]).removeClass(a._select.className)})});
this.iterator("table",function(a,b){k(c,"deselect",["column",c[b]],!0)});return this});m("cells().deselect()","cell().deselect()",function(){var c=this;this.iterator("cell",function(a,b,c){b=a.aoData[b];b._selected_cells[c]=!1;b.anCells&&!a.aoColumns[c]._select_selected&&e(b.anCells[c]).removeClass(a._select.className)});this.iterator("table",function(a,b){k(c,"deselect",["cell",c[b]],!0)});return this});e.extend(g.ext.buttons,{selected:{text:o("selected","Selected"),className:"buttons-selected",
init:function(c){var a=this;c.on("draw.dt.DT select.dt.DT deselect.dt.DT",function(){var b=a.rows({selected:!0}).any()||a.columns({selected:!0}).any()||a.cells({selected:!0}).any();a.enable(b)});this.disable()}},selectedSingle:{text:o("selectedSingle","Selected single"),className:"buttons-selected-single",init:function(c){var a=this;c.on("draw.dt.DT select.dt.DT deselect.dt.DT",function(){var b=c.rows({selected:!0}).flatten().length+c.columns({selected:!0}).flatten().length+c.cells({selected:!0}).flatten().length;
a.enable(1===b)});this.disable()}},selectAll:{text:o("selectAll","Select all"),className:"buttons-select-all",action:function(){this[this.select.items()+"s"]().select()}},selectNone:{text:o("selectNone","Deselect all"),className:"buttons-select-none",action:function(){n(this.settings()[0],!0)}}});e.each(["Row","Column","Cell"],function(c,a){var b=a.toLowerCase();g.ext.buttons["select"+a+"s"]={text:o("select"+a+"s","Select "+b+"s"),className:"buttons-select-"+b+"s",action:function(){this.select.items(b)},
init:function(a){var c=this;a.on("selectItems.dt.DT",function(a,d,e){c.active(e===b)})}}});e(l).on("preInit.dt.dtSelect",function(c,a){if("dt"===c.namespace){var b=a.oInit.select||g.defaults.select,d=new g.Api(a),h="row",i="api",f=!1,k=!0,l="td, th",m="selected";a._select={};if(!0===b)i="os";else if("string"===typeof b)i=b;else if(e.isPlainObject(b)&&(b.blurable!==j&&(f=b.blurable),b.info!==j&&(k=b.info),b.items!==j&&(h=b.items),b.style!==j&&(i=b.style),b.selector!==j&&(l=b.selector),b.className!==
j))m=b.className;d.select.selector(l);d.select.items(h);d.select.style(i);d.select.blurable(f);d.select.info(k);a._select.className=m;e(d.table().node()).hasClass("selectable")&&d.select.style("os")}});return g.select});
